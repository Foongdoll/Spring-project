                        ...
                        <div class="login-form">
                            <form name="myform" method="post" action="${ctp}/join" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="${photo}" id="preview" width="1000px" style="position: absolute;z-index: 1;width: 525px;height: 300px"/>
                                    <input type="hidden" name="mem_photo" id="hiddenphoto" value="${photo}"/>
                                    </div>
                                </div>
                                <button type="button" onclick="fCheck()" class="btn oneMusic-btn mt-30">회원가입</button>
                                <input type="hidden" name="googleSw" value="1"/>
                            </form>
                        </div>
                    </div>
                </div>
