                        ...
                        <div class="login-form">
                            <form name="myform" method="post" action="${ctp}/join" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id" name="mem_id" aria-describedby="emailHelp" maxlength="16" placeholder="아이디를 입력해주세요." value="${fn:substring(email,0,fn:indexOf(email,'@')) }">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="mem_name" value="${vo.mem_name }"  maxlength="20" placeholder="이름을 입력해주세요." readonly>
                                    <small id="emailHelp" class="form-text text-muted"><i class="fa fa-lock mr-2"></i>영어 대/소문자와 한글만 가능하며 최소 2자리 최대 20자리입니다.</small>
                                </div>
                                <div class="form-group">
                                    <label for="name">닉네임</label>
                                    <input type="text" class="form-control" id="nickName" name="mem_nickName" value="${vo.mem_nickName }" readonly maxlength="20" placeholder="이름을 입력해주세요." readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="mem_email" value="${vo.mem_email }" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="${vo.mem_photo}" id="preview" width="1000px" style="position: absolute;z-index: 1;width: 525px;height: 300px"/>
                                    <input type="hidden" name="mem_photo" id="hiddenphoto" value="${vo.mem_photo}"/>
                                    </div>
                                </div>
                                <button type="button" onclick="fCheck()" class="btn oneMusic-btn mt-30">회원가입</button>
                                <input type="hidden" name="naverSw" value="1"/>
                            </form>
                        </div>
                    </div>
                </div>
